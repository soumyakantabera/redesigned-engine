...
const pageTitle = "Book Free Demo | Learn With Smile";
const pageDesc = "Book a free live demo class — fill 4 fields, we confirm on WhatsApp instantly. English, Excel, Data Analytics — your choice.";
...
export const Route = createFileRoute("/book-free-demo")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: `${SITE}/book-free-demo` },
    ...
    links: [{ rel: "canonical", href: `${SITE}/book-free-demo` }],
  }),
});
      ...
      <section className="relative">
        ...
        <div className="container-x py-16 md:py-24 text-cream max-w-3xl">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <WaButton message="Hi, I visited the Book Free Demo page. Please give me a callback instead." variant="sun" size="lg">Get a Callback</WaButton>
            <WaButton message="Hi, I'd like to book a free demo." variant="wa" size="lg">Chat on WhatsApp</WaButton>
          </div>
        </div>
      </section>
...
function FaqSection() {
  return (
    <FaqSectionBase
      items={GENERAL_FAQS}
      footerImage={Images.womanLaptop}
    />
  );
}
