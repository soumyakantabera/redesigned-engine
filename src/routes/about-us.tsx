...
const pageTitle = "About Learn With Smile | 7 Years of Live Online Teaching";
const pageDesc = "Our story, mission, and 11 learning principles. Live online classes for Indian learners — small batches, gamified, student-first.";
...
export const Route = createFileRoute("/about-us")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: `${SITE}/about-us` },
    ...
    links: [{ rel: "canonical", href: `${SITE}/about-us` }],
  }),
});
    ...
    <Layout waMessage="Hi, I just read About Us. I'd like a free demo." footerImage={IMG.team}>
      <section className="relative">
        ...
        <div className="container-x py-16 md:py-24 text-cream max-w-3xl">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <WaButton message="Hi, I just read About Us. Please give me a callback." variant="sun" size="lg">Get a Callback</WaButton>
            <WaButton message="Hi, I just read About Us. I'd like a free demo." variant="wa" size="lg">Book Free Demo</WaButton>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-16">
        ...
        <div className="container-x grid grid-cols-2 md:grid-cols-5 gap-8">
          <Stat num="7" label="Years Teaching"/><Stat num="500+" label="Learners"/><Stat num="5.0★" label="Avg Rating"/><Stat num="100%" label="Completion Rate"/><Stat num="95%" label="Course Satisfaction"/>
        </div>
      </section>
      ...
      <FaqSection items={GENERAL_FAQS} footerImage={IMG.team} />
    </Layout>
  );
}
