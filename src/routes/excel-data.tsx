...
const pageDesc = "8 live online courses: MS Office, Master Excel, Finance Excel, Python, Power BI, Prompt Engineering, Building with Claude API & AI Projects. 1:1 personalised.";
...
export const Route = createFileRoute("/excel-data")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://learnwithsmile.in/excel-data" },
    ...
    <Layout waMessage={wa} footerImage={IMG.presentation}>
      <section className="relative">
        ...
        <div className="container-x py-16 md:py-24 text-cream max-w-3xl">
          ...
          <p className="mt-5 text-lg text-white">Eight 100% online live courses — 1:1 personalised, flexible morning/evening/weekend slots. Every course ships with India-context capstone projects. Easy monthly plans available.</p>
          <div className="mt-6 flex flex-wrap gap-3">
            <WaButton message={wa} variant="sun" size="lg">Free Demo on WhatsApp</WaButton>
            <WaButton message="Hi, I am browsing the Excel, Data & AI track. Please give me a callback." variant="wa" size="lg">Get a Callback</WaButton>
            <WaButton message="Hi, please send me pricing for all Excel, Data & AI courses." variant="outline" size="lg">Get All Pricing</WaButton>
          </div>
        </div>
      </section>
      ...
      <section className="section bg-indigo-pop">
        <div className="container-x grid lg:grid-cols-[1.2fr_1fr] gap-10 items-center">
          <div className="text-cream">
            ...
            <p className="mt-3 text-white/95">Prompt Engineering, Building with Claude API & MCP, and AI Projects for academic & industrial work. Live, 1:1 personalised.</p>
...
import { FaqSection as FaqSectionBase } from "@/components/FaqSection";
import { GENERAL_FAQS } from "@/lib/faqs";
import { IMG as Images } from "@/lib/images";

function FaqSection() {
  return (
    <FaqSectionBase
      items={GENERAL_FAQS}
      footerImage={Images.presentation}
    />
  );
}
