...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "Learn With Smile — Live Online Classes, India | 7 Years Teaching" },
      ...
      { property: "og:description", content: "Live online classes in English, Excel, Power BI, Python & AI with Claude/ChatGPT. Max 6 per batch or 1:1." },
      { property: "og:image", content: IMG.heroClass },
      { property: "og:url", content: "https://learnwithsmile.in/" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Learn With Smile | Live English, Excel, Data & AI Classes" },
      { name: "twitter:description", content: "Live online classes in English, Excel, Power BI, Python & AI with Claude/ChatGPT. Max 6 per batch or 1:1." },
      { name: "twitter:image", content: IMG.heroClass },
    ],
    links: [{ rel: "canonical", href: "https://learnwithsmile.in/" }],
    scripts: [
      {
        ...
        <div className="container-x py-20 md:py-32 grid lg:grid-cols-[1.3fr_1fr] gap-10 items-center">
          <div className="text-cream">
            ...
            <p className="mt-6 text-lg text-white max-w-xl">
              Real teachers. Small batches. Gamified, interactive live classes — designed for the demands of today's market.
            </p>
      ...
      <section className="section">
        <div className="container-x">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <TrackCard to="/english-career" tag="6 Courses · Live Online" title="English & Career" desc="Spoken English · Business English · Interactive Speaking · IELTS · Interview Prep · Career Counselling" img={IMG.speaking} accent="brand"/>
            <TrackCard to="/excel-data" tag="8 Courses · Live Online" title="Excel, Data & AI" desc="MS Office · Master Excel · Finance Excel · Python · Power BI · Prompt Engineering · Claude API · AI Projects" img={IMG.dataDash} accent="indigo"/>
          </div>
      ...
      <section className="relative section overflow-hidden">
        ...
        <div className="container-x">
          ...
          <div className="grid md:grid-cols-2 gap-5 mb-12">
            <GlassCard icon="users" title="Batch Classes" pricing="Affordable Plans">
