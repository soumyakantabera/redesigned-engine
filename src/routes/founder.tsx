...
export const Route = createFileRoute("/founder")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: `${SITE}/founder` },
    ...
    links: [{ rel: "canonical", href: `${SITE}/founder` }],
  }),
});
      ...
      <section className="relative">
        ...
        <div className="container-x py-16 md:py-24 text-cream max-w-3xl">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <WaButton message="Hi founders, I want a free demo. Please guide me." variant="wa" size="lg">Book Free Demo</WaButton>
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container-x">
          <FounderCard
            ...
            image={IMG.founder}
            intro="Over the past 7+ years, I have dedicated myself to teaching English and empowering students to build meaningful careers — from school students and homemakers to working professionals. My lived experience on a global platform has immersed me in diverse international environments, bringing real-world perspective into every classroom. Having personally navigated the journey of learning foreign languages — French and Italian — I understand the struggle firsthand, and that fuels my passion for turning the complexity of communication into something natural, confident, and achievable."
            credentials={[
...
function FaqSection() {
  return (
    <FaqSectionBase
      items={GENERAL_FAQS}
      footerImage={Images.teacherWoman}
    />
  );
}
