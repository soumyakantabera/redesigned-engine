...
const pageDesc = "6 live online courses: Basic Spoken English, Business English, Interactive Speaking, IELTS, Interview Prep, Career Counselling. Max 6 per batch.";
...
export const Route = createFileRoute("/english-career")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://learnwithsmile.in/english-career" },
    ...
    <Layout waMessage={wa} footerImage={IMG.groupClass}>
      <section className="relative">
        ...
        <div className="container-x py-16 md:py-24 text-cream max-w-3xl">
          ...
          <p className="mt-5 text-lg text-white">Six 100% online live courses — max 6 per batch (1:1 for Career Counselling). Flexible morning, evening & weekend slots. Easy monthly plans available.</p>


          <div className="mt-6 flex flex-wrap gap-3">
            <WaButton message={wa} variant="sun" size="lg">Free Demo on WhatsApp</WaButton>
            <WaButton message="Hi, I am browsing the English & Career track. Please give me a callback." variant="wa" size="lg">Get a Callback</WaButton>
            <WaButton message="Hi, please send me pricing for all English & Career courses." variant="outline" size="lg">Get All Pricing</WaButton>
          </div>
        </div>
      </section>
