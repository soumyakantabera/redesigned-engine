...
const ENGLISH_COURSES: NavItem[] = [
  { to: "/course-spoken-english", label: "Basic Spoken English", icon: "mic", desc: "6 months · live batch" },
  { to: "/course-business-english", label: "Business English", icon: "headset", desc: "3 months · live batch" },
  { to: "/course-interactive-speaking", label: "Interactive Speaking", icon: "headset", desc: "3 months · live batch" },
  { to: "/course-ielts", label: "IELTS Preparation", icon: "trophy", desc: "3 months · live batch" },
  { to: "/course-interview-prep", label: "Interview Prep", icon: "target", desc: "2 months · live batch" },
  { to: "/course-career-counselling", label: "Career Counselling", icon: "compass", desc: "3 × 60-min · personalised" },
];

const DATA_COURSES: NavItem[] = [
  { to: "/course-ms-office", label: "MS Office Essentials", icon: "book", desc: "1:1 · personalised" },
  { to: "/course-master-excel", label: "Master Excel", icon: "chart", desc: "1:1 · personalised" },
  { to: "/course-finance-excel", label: "Finance Excel", icon: "rupee", desc: "1:1 · personalised" },
  { to: "/course-python", label: "Python", icon: "code", desc: "1:1 · personalised" },
  { to: "/course-power-bi", label: "Power BI", icon: "chart", desc: "1:1 · personalised" },
  { to: "/course-prompt-engineering", label: "Prompt Engineering", icon: "rocket", desc: "1:1 · personalised" },
  { to: "/course-ai-builder", label: "Claude API & Agentic AI", icon: "rocket", desc: "1:1 · personalised" },
  { to: "/course-ai-projects", label: "AI Projects", icon: "trophy", desc: "1:1 · personalised" },
];
